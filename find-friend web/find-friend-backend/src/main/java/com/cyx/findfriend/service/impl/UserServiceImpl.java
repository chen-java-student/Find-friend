...
import com.cyx.findfriend.utils.AlgorithmUtils;
...
import static com.cyx.findfriend.contant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
     ...
     * 盐值，混淆密码
     */
      private static final String SALT = "cyx";
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword, String planetCode) {
        ...
        // 2. 加密
       String encryptPassword = userPassword; //DigestUtils.md5DigestAsHex((SALT + userPassword).getBytes());
        // 3. 插入数据
        User user = new User();
